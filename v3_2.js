...
(function () {
  ...
  var FALLBACK_REFERENCE_IMAGE_URL =
    "https://tattty-uploads.tattty.com/TaTTTy-Logo-1024x1024%20(3).png";
  ...
  var styles = {
    ...
    outer:
      "width:100%;max-width:1180px;height:680px;display:flex;background:#fff;border-radius:24px;overflow:hidden;box-shadow:0 1px 2px rgba(20,30,60,.04),0 26px 64px -36px rgba(40,80,170,.22);",
    outerRow: "flex-direction:row;",
    outerColumn: "flex-direction:column;height:auto;",

    leftPanel:
      "min-width:0;display:flex;flex-direction:column;padding:26px;box-sizing:border-box;",
    leftPanelRow: "flex:1;",
    leftPanelColumn: "flex:none;min-height:62vh;",

    dropZone:
      "flex:1;min-height:0;display:flex;align-items:center;justify-content:center;position:relative;border-radius:16px;background:#f6faff;overflow:hidden;",

    imageWrap:
      "position:relative;width:100%;height:100%;display:flex;align-items:center;justify-content:center;",
    previewImg: "width:100%;height:100%;object-fit:contain;display:block;",
    removeBtn:
      "position:absolute;top:12px;right:12px;width:38px;height:38px;border-radius:50%;border:none;background:rgba(255,255,255,.94);box-shadow:0 2px 10px rgba(0,0,0,.2);display:flex;align-items:center;justify-content:center;cursor:pointer;",
    ...
    uploadBtn:
      "display:flex;align-items:center;gap:9px;padding:12px 20px;border-radius:12px;border:1px solid #dfe2e6;background:#fff;font-size:14.5px;font-weight:500;color:#141414;cursor:pointer;",
    uploadBtnSolid:
      "display:flex;align-items:center;gap:9px;padding:12px 20px;border-radius:12px;border:none;background:#f1f2f4;font-size:14.5px;font-weight:500;color:#141414;cursor:pointer;",
    ...
    captureBtn:
      "padding:12px 26px;border-radius:12px;border:none;background:#16181a;color:#fff;font-size:14.5px;font-weight:600;cursor:pointer;",
    cancelBtn:
      "padding:12px 22px;border-radius:12px;border:1px solid #dfe2e6;background:#fff;color:#141414;font-size:14.5px;font-weight:500;cursor:pointer;",

    resultsOverlay:
      "position:absolute;inset:0;padding:2px;display:flex;align-items:center;justify-content:center;",
    resultsGrid:
      "display:grid;grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(2,1fr);gap:10px;aspect-ratio:1;max-width:100%;max-height:100%;",
    resultsGridFitH: "height:100%;",
    resultsGridFitW: "width:100%;",
    resultTile:
      "position:relative;min-height:0;min-width:0;border-radius:12px;overflow:hidden;background:#f3f3f4;box-shadow:0 4px 10px rgba(0,0,0,.12);",
    shimmer:
      "position:absolute;inset:0;background:linear-gradient(110deg,#ececec 8%,#f6f6f6 18%,#ececec 33%);background-size:440px 100%;animation:tattty3-shimmer 1.4s infinite linear;display:flex;align-items:center;justify-content:center;",
    spinnerCircle:
      "width:38px;height:38px;border-radius:50%;border:3px solid #dadadd;border-top-color:#a9abb0;animation:tattty3-spin .9s linear infinite;",
    resultImg:
      "width:100%;height:100%;object-fit:cover;display:block;cursor:zoom-in;",
    resultActions:
      "position:absolute;bottom:8px;right:8px;display:flex;gap:7px;",
    resultActionBtn:
      "width:32px;height:32px;border-radius:8px;border:none;background:rgba(0,0,0,.6);color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;",

    promptWrap: "flex:none;margin-top:18px;padding-top:16px;",
    textarea:
      "width:100%;min-height:58px;max-height:130px;resize:vertical;border:1px solid #e6e8ec;border-radius:14px;padding:12px 14px;font-size:14px;line-height:1.45;color:#141414;outline:none;background:#fff;font-family:inherit;",
    noticeRow:
      "display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:5px;",
    notice: "flex:1;line-height:1.05;",
    noticeNormal:
      "font-size:12.5px;color:#8b8f96;font-weight:400;text-align:left;",
    noticeError:
      "font-size:16px;color:#c0392b;font-weight:600;text-align:center;",

    rightPanel:
      "flex:none;display:flex;flex-direction:column;gap:10px;box-sizing:border-box;",
    rightPanelRow: "width:300px;padding:26px 26px 26px 0;",
    rightPanelColumn: "width:100%;padding:14px;",

    infoRow:
      "flex:none;padding:11px 14px;border-radius:14px;background:#f7f7f8;border:1px solid #ededf0;display:flex;align-items:center;justify-content:space-between;",
    infoLabel: "font-size:12.5px;color:#8b8f96;font-weight:500;",
    infoValue: "font-size:14px;font-weight:600;color:#141414;",
    triggerBadge:
      "font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:13.5px;font-weight:600;color:#141414;background:#ececec;border:1px solid #e0e0e3;border-radius:8px;padding:5px 11px;",

    refImageWrap:
      "flex:1;min-height:0;display:flex;align-items:flex-start;justify-content:center;overflow:hidden;",
    refImageBox:
      "width:100%;aspect-ratio:1/1;border-radius:14px;overflow:hidden;background:#f0f0f2;border:1px solid #ededf0;display:flex;align-items:center;justify-content:center;",
    refImagePlaceholder:
      "display:flex;flex-direction:column;align-items:center;gap:8px;color:#b4b7bd;text-align:center;padding:20px;font-size:12px;font-family:ui-monospace,Menlo,monospace;",
    refImg: "width:100%;height:100%;object-fit:cover;display:block;",

    outputsRow:
      "flex:none;padding:11px 14px;border-radius:14px;background:#f7f7f8;border:1px solid #ededf0;display:flex;align-items:center;gap:14px;",
    outputsLabel: "font-size:12.5px;color:#8b8f96;font-weight:500;flex:none;",
    outputsSlider: "flex:1;min-width:0;cursor:pointer;",
    outputsValue:
      "font-size:14px;font-weight:700;color:#141414;flex:none;min-width:14px;text-align:right;",

    generateBtn:
      "flex:none;width:100%;height:53.5px;display:flex;align-items:center;justify-content:center;border:none;border-radius:14px;padding:0 12px;line-height:1;font-family:'Rock Salt',cursive;font-size:17px;font-weight:600;color:#fff;background:#16181a;cursor:pointer;",

    lightboxOverlay:
      "position:fixed;inset:0;background:rgba(0,0,0,.92);z-index:1000;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;",
    lightboxClose:
      "position:absolute;top:16px;right:22px;background:none;border:none;color:#fff;font-size:36px;line-height:1;cursor:pointer;",
    lightboxNav:
      "position:absolute;top:50%;transform:translateY(-50%);width:48px;height:48px;border-radius:50%;border:none;background:rgba(255,255,255,.14);color:#fff;font-size:30px;line-height:1;cursor:pointer;",
    lightboxImg:
      "max-width:min(92%,760px);max-height:74vh;object-fit:contain;border-radius:8px;box-shadow:0 10px 40px rgba(0,0,0,.5);",
    lightboxActions: "display:flex;gap:12px;margin-top:18px;",
    lightboxActionBtn:
      "display:flex;align-items:center;gap:8px;background:rgba(255,255,255,.12);color:#fff;border:1px solid rgba(255,255,255,.3);border-radius:8px;padding:10px 18px;font-size:14px;font-weight:500;cursor:pointer;",
  ...
  function mount(root) {
    ...
    var artistRatingAttr = parseFloat(
      root.getAttribute("data-artist-model-rating"),
    );
    var artistRating = isNaN(artistRatingAttr) ? 4.8 : artistRatingAttr;
    var referenceImageUrl =
      root.getAttribute("data-image-url") || FALLBACK_REFERENCE_IMAGE_URL;
    ...
    var textarea = el("textarea", styles.textarea, {
      rows: "3",
      placeholder:
        "Or describe your own style — type a prompt to generate without picking presets…",
    });
    ...
    var ratingLabel = el("span", styles.infoLabel, {
      text: "Artist Model Rating",
    });
    ...
    function renderStars() {
      ...
      for (var i = 0; i < 5; i++) {
        ...
        star.innerHTML =
          ...
          '" stroke="' +
          fillColor +
          '" stroke-width="1.2" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>';
    ...
    function buildUploadPrompt() {
      ...
      var hint = el("div", styles.uploadHint, {
        text: "Start camera, upload a photo, or drag and drop an image.",
      });
      ...
      if (state.cameraError) {
        wrap.appendChild(
          el("div", styles.cameraError, { text: state.cameraError }),
        );
      }
      return wrap;
    }
    ...
    function startCamera() {
      navigator.mediaDevices
        ...
        .catch(function () {
          state.cameraError =
            "Camera unavailable here — upload or drag a photo instead.";
          renderDropZone();
        });
    }
    ...
    function buildCameraView() {
      ...
      var captureBtn = el("button", styles.captureBtn, {
        type: "button",
        text: "Capture",
      });
      captureBtn.addEventListener("click", capturePhoto);
      var cancelBtn = el("button", styles.cancelBtn, {
        type: "button",
        text: "Cancel",
      });
    ...
    function buildImagePreview() {
      ...
      var img = el("img", styles.previewImg, {
        src: state.imageSrc,
        alt: "upload",
      });
      var removeBtn = el("button", styles.removeBtn, {
        type: "button",
    ...
    function buildResultTile(idx, item) {
      ...
      if (item.status === "loading") {
        ...
        var img = el("img", styles.resultImg, {
          src: item.src,
          alt: item.label || "Generated result " + (idx + 1),
        });
        ...
        var dlBtn = el("button", styles.resultActionBtn, {
          type: "button",
          title: "Download",
        });
        ...
        var shareBtn = el("button", styles.resultActionBtn, {
          type: "button",
          title: "Share",
        });
    ...
    function buildResultsOverlay() {
      ...
      var grid = el(
        "div",
        styles.resultsGrid +
          (isMobile() ? styles.resultsGridFitW : styles.resultsGridFitH),
      );
    ...
    function renderLightbox() {
      ...
      var closeBtn = el("button", styles.lightboxClose, {
        type: "button",
        "aria-label": "Close",
      });
      ...
      if (idx > 0) {
        var prevBtn = el("button", styles.lightboxNav + "left:18px;", {
          type: "button",
          "aria-label": "Previous",
        });
        prevBtn.textContent = "‹";
      ...
      if (idx < state.results.length - 1) {
        var nextBtn = el("button", styles.lightboxNav + "right:18px;", {
          type: "button",
          "aria-label": "Next",
        });
        nextBtn.textContent = "›";
      ...
      var img = el("img", styles.lightboxImg, {
        src: item.src,
        alt: item.label || "",
      });
    ...
    function runGeneration(prompt, n) {
      ...
      if (state.file) {
        ...
        uploadPromise = fetch(UPLOAD_URL, { method: "POST", body: fd })
          ...
          .then(function (data) {
            if (!data || !data.url)
              throw new Error(
                "Upload returned no url. Response: " +
      ...
      uploadPromise
        ...
        .then(function (data) {
          ...
          if (!urls.length)
            throw new Error(
              "Worker returned no urls. Response: " +
                JSON.stringify(data).slice(0, 200),
            );
